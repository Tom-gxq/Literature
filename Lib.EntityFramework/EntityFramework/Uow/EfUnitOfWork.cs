...
namespace Lib.EntityFramework.EntityFramework.Uow
{
    ...
    {
        private readonly IDictionary<Type, ILibDbContext> _activeDbContexts;
            ...
            : base(defaultOptions)
        {
            ...
            _activeDbContexts = new Dictionary<Type, ILibDbContext>();
        }
        ...
        internal TDbContext GetOrCreateDbContext<TDbContext>()
            where TDbContext : ILibDbContext
        {
            ILibDbContext dbContext;
        ...
        protected virtual void SaveChangesInDbContext(ILibDbContext dbContext)
        {
            //dbContext.SaveChanges();
        }

        protected virtual async Task SaveChangesInDbContextAsync(ILibDbContext dbContext)
        {
