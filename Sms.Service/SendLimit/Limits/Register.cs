    ...
    public class Register : ILimit
    {
        ...
        public static int IpLimitCount
        {
            get
            {
                ...
                if (config != null)
                {
                    var reObj = config.GetSection("SameIPRegLimitCount");
        ...
        public static int IpLimitCountDays
        {
            get
            {
                ...
                if (config != null)
                {
                    var reObj = config.GetSection("SameIPRegLimitCountDays");
        ...
        public static int MobilePhoneLimitCount
        {
            get
            {
                ...
                if (config != null)
                {
                    var reObj = config.GetSection("SameMobilePhoneRegLimitCount");
        ...
        public static int MobilePhoneLimitCountDays
        {
            get
            {
                ...
                if (config != null)
                {
                    var reObj = config.GetSection("SameMobilePhoneRegLimitCountDays");
        ...
        private Proxy GetProxy()
        {
            ...
            {
                Proxy proxy = new Proxy(SendMessageFromType.Register);
