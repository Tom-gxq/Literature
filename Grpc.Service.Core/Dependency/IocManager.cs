...
namespace Grpc.Service.Core.Dependency
{
    /// <summary>
    ...
    public class IocManager : IIocManager
    {
        ...
        public void Register<TType>(TType obj,DependencyLifeStyle lifeStyle = DependencyLifeStyle.Singleton) where TType : class
        {
            IocContainer.Register(ApplyLifestyle(Component.For<TType>().Instance(obj), lifeStyle));
        }
