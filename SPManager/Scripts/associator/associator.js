...
define(function (require, exports, module) {
    ...
    var addadmin = require('add-associatorItem');
     ...
     * 角色设置模块
     */
    var AssociatorController = $.extend({
        /**
         * 模块入口
         */
        init: function (para) {
        ...
        dataBinding: function (data) {
            var _self = this
            items = '';
            doT.exec('associator/list-item.html', function (templateFun) {
        ...
        bindEvent: function () {
            var _self = this;
            $('#btnAddAdmin').bind('click', function () {
                //弹出添加的操作框
                addadmin.init({
                    stepOne: true,
                    dialogID: 'wizard',
                    ...
                    callBack: function (result) {
                        if (result) {
                            //重新加载页面
                            window.location.href = '/Associator/Index';
                        } else {
                            alert('添加会员失败');
                        }
                    }
        ...
        getAdiminList: function (index) {
            var _self = this;
            $.ajax({
                url: 'SearchAssociatorByAccountId',
                type: 'GET',
                cache: false,
                data: {
    ...
    exports.jQuery = $;
    exports.AssociatorController = AssociatorController;
});