...
define(function (require, exports, module) {
    ...
    var addbrand = require('add-brand');
    var editbrand = require('edit-brand');
    ...
    var BrandController = $.extend({
        ...
        dataBinding: function (data) {
            var _self = this
            items = '';
            doT.exec('brand/list-item.html', function (templateFun) {
        ...
        getBrandList: function (index) {
            var _self = this;
            $.ajax({
                url: 'SearchBrandByName',
                type: 'GET',
                cache: false,
                data: {
                    brandName: $("#inputSearch").val(),
                    pageIndex: index,
                    pageSize: 20
                },
                success: function (msg) {
