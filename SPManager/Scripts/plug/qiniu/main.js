...
define(function (require, exports, module) {
     ...
     * 分类设置模块
     */
    var QiniuMainController = $.extend({
        /**
         * 模块入口
         */
        init: function (para) {
                ...
                init: {
                    ...
                    'FileUploaded': function (up, file, info) {
                        ...
                        if (res.key != null && res.key != "")
                        {
                            var image = {
                                ImgPath: res.key,
                                ProductId: $("#wizard").find('.txtId').val()

                            };
                            image = $.param(image, true);
                            Global.post("/Product/AddProductImage", image, function (data) {
                                if (data.result) {
                    ...
                    'Key': function (up, file) {
                        ...
                        var key = "pic_" + myDate.getFullYear() + "" + myDate.getMonth() + "" + myDate.getDate() + "" + myDate.getHours() + "" + myDate.getMinutes() + "" + myDate.getSeconds() + "" + myDate.getMilliseconds() ;
    ...
    exports.jQuery = $;
    exports.QiniuMainController = QiniuMainController;
});
