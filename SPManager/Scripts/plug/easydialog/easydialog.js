    ...
    var easyDialog = function () {
        ...
        Dialog.prototype = {
            ...
            createDialogWrap: function (tmpl) {
                ...
                '<h4 class="easyDialog_title" id="easyDialogTitle"><a href="javascript:void(0)" title="关闭窗口" class="close_btn" id="closeBtn">&times;</a><span>&nbsp;</span>' + tmpl.header + '</h4>' :
                    '',
                    // 确定按钮
        ...
        var extend = {
            open: function () {
                ...
                // 如果页面中已经缓存遮罩层，直接显示
                if (options.overlay) {
                    overlay = doc.getElementById('crm_overlay');
                    if (!overlay) {
                ...
                var closeBtn = doc.getElementById('closeBtn'),
                    ...
                    overlayer = doc.getElementById('crm_overlay');
