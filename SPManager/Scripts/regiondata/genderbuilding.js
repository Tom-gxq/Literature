...
define(function (require, exports, module) {
    ...
    //默认参数
    var Defaults = {
        dialogID: "genderBuilding",//弹出框ID
        orderID: ''
    };
    var setting = {};
    var GenderBuilding = function (options) {
        var _this = this;
    ...
    GenderBuilding.prototype = {
        ...
        */
        showDialog: function (options) {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    if (msg.result) {
                        doT.exec('regiondata/genderbuilding.html', function (templateFun) {
                            var innerText;
        ...
        Submit: function (elementID) {
            ...
            Global.post("/RegionData/GenderBuildingNum", type, function (data) {
    ...
    exports.init = function (options) {
        return new GenderBuilding(options);
    }
    return exports
});