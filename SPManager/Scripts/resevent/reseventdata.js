...
define(function (require, exports, module) {
    ...
    var addresevent = require('add-resevent');
    ...
    var ReseventController = $.extend({
        ...
        dataBinding: function (data) {
            var _self = this
            items = '';
            doT.exec('resevent/list-item.html', function (templateFun) {
    ...
    exports.jQuery = $;
    exports.ReseventController = ReseventController;
});