    ...
    AddProduct.prototype = {
        ...
        */
        showDialog: function () {
            ...
            $.ajax({
                url: 'GetSellerProductList',
                type: 'GET',
                cache: false,
                success: function (msg) {
                    doT.exec('seller/addproduct.html', function (templateFun) {
                        var innerText;
