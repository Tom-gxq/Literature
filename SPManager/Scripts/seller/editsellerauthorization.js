...
define(function (require, exports, module) {
    ...
    //默认参数
    var Defaults = {
        dialogID: "editsellerauthorization"//弹出框ID
    };
        ...
        */
        showDialog: function () {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    doT.exec('seller/editsellerauthorization.html', function (templateFun) {
                        var innerText;
        ...
        Submit: function (elementID) {
            ...
            var param = {
                ...
                AuthorizationPath: divElement.find('#imgPath').val(),
            };
            param = $.param(param, true);
            Global.post("/Seller/EditSellerAuthorization", param, function (data) {
