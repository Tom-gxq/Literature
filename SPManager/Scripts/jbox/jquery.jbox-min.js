!function (a, b, c) {
    ...
    function e(b, d) {
        var e = b.outerWidth(), f = b.outerHeight(), g = a(c), i = g.height(), l = g.width(), m = b.find(".jbox-title").outerHeight(), n = b.find(".jbox-buttons").outerHeight(), o = b.find(".jbox-container"), p = h(d);
        if ("auto" == p.width ? (e < p.minWidth && (e = p.minWidth), e > 900 && (e = 900)) : e = p.width, e >= l && (e = l - 50), "auto" == p.height ? (f < p.minHeight && (f = p.minHeight), f >= i && (f = i - 100)) : f = p.height, f >= i && (f = i - 50), o.css("height", f - m - n - parseInt(o.css("paddingTop")) - parseInt(o.css("paddingBottom"))), b.css({
            ...
            b.css({position: "absolute", top: i / 2 + q})
        }
    }

    function f() {
        a("#jbox-overlay").length < 1 && a("body").append('<div id="jbox-overlay"></div>');
        var b = a("#jbox-overlay"), d = a(c), e = a("body").height(), f = d.height(), g = f > e ? f : e;
        if (b.css({
                position: "fixed",
                zIndex: 99995,
                top: "0px",
    ...
    var i = {
        ...
        onOpen: !1,
        onClosed: !1,
        btnOK: {text: "确定", show: !0, extclass: "btn btn-primary", onBtnClick: !1},
        btnCancel: {text: "取消", show: !0, extclass: "btn", onBtnClick: !1}
    }, j = a.browser.msie, k = parseInt(a.browser.version);
    d.prototype.create = function (b, c) {
        var d = this.title, h = this.selector, i = null, j = null;
        this.$content = i = this.$content ? this.$content : a(h);
        try {
            this.$curParent = j = i.parent()
        } catch (k) {
        }
        var l = a('<div class="jbox"></div>'), m = a('<div class="jbox-title"></div>'), n = a('<div class="jbox-container"></div>'), o = a('<div class="jbox-buttons"></div>');
        ...
        return this.each(function () {
            var c = a(this), e = c.data("rule") || "normal", f = h(b ? b : {});
            if (f.trigger = this, "box" == e)c.click(function () {
                var a = new d({title: c.attr("title") || f.title, selector: c.attr("href")});
                return a.create(f, f.onOpen), !1
            }); else {
                var g = new d({title: f.title, $content: c});
                g.create(f, f.onOpen)
            }
        })
    };
    var l = a.jBox = {};
    l.show = function (a) {
        var b = h(a ? a : {}), c = new d({title: b.title, $content: b.content});
        c.create(b, b.onOpen)
