        ...
        showDialog: function () {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    if (msg.result ) {
                        doT.exec('type/edittype.html', function (templateFun) {
                            var innerText;
